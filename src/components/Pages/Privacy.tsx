  ...
  <Fragment>
    ...
    <div class="page-wrapper">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Marek Dev.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Marek Dev, accessible from{' '}
            <a href="https://books.marek.dev">https://books.marek.dev</a>
          </p>
        </li>
        <li>
          <p>
      ...
      <p>
        ...
        are deleted as soon as You close your web browser. We use both session and persistent
